...
public static RemoteObject  _coffee_stamp(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("Coffee_Stamp (card) ","card",2,__ref.getField(false, "ba"),__ref,12);
if (RapidSub.canDelegate("coffee_stamp")) return __ref.runUserSub(false, "card","coffee_stamp", __ref);
