...
public static RemoteObject _scanner = RemoteObject.declareNull("b4a.example.scan");
...
public static b4a.example.themecalc _themecalc = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"btnScan",main.mostCurrent._btnscan,"Card",Debug.moduleToString(b4a.example.card.class),"CoffeeCount",main._coffeecount,"imgLogo",main.mostCurrent._imglogo,"imgStamp1",main.mostCurrent._imgstamp1,"imgStamp2",main.mostCurrent._imgstamp2,"imgStamp3",main.mostCurrent._imgstamp3,"imgStamp4",main.mostCurrent._imgstamp4,"imgStamp5",main.mostCurrent._imgstamp5,"imgStamp6",main.mostCurrent._imgstamp6,"Label1",main.mostCurrent._label1,"lblCompanyName",main.mostCurrent._lblcompanyname,"mResult",main._mresult,"myABBarcode",main.mostCurrent._myabbarcode,"myColors",main._mycolors,"myCoName",main._myconame,"myLogo",main._mylogo,"myStamp",main._mystamp,"myTheme",main.mostCurrent._mytheme,"pnlBG",main.mostCurrent._pnlbg,"pnlStamp1",main.mostCurrent._pnlstamp1,"pnlStamp2",main.mostCurrent._pnlstamp2,"pnlStamp3",main.mostCurrent._pnlstamp3,"pnlStamp4",main.mostCurrent._pnlstamp4,"pnlStamp5",main.mostCurrent._pnlstamp5,"pnlStamp6",main.mostCurrent._pnlstamp6,"Scanner",main.mostCurrent._scanner,"ThemeCalc",Debug.moduleToString(b4a.example.themecalc.class)};
}
}