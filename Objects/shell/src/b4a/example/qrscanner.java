...
public class qrscanner implements IRemote{
	public static qrscanner mostCurrent;
...
public boolean isSingleton() {
    ...
    public static PCBA staticBA = new PCBA(null, qrscanner.class);
    private PCBA pcBA;
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(null, qrscanner.class);
		return pcBA;
	}
