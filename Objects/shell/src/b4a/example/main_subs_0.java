...
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("main")),main.mostCurrent.activityBA);
 BA.debugLineNum = 57;BA.debugLine="myTheme.Initialize ' initialise theme database on";
Debug.ShouldStop(16777216);
main.mostCurrent._mytheme.runClassMethod (b4a.example.coffeetheme.class, "_initialize",main.processBA);
 BA.debugLineNum = 58;BA.debugLine="loadDBcolours";
Debug.ShouldStop(33554432);
_loaddbcolours();
 BA.debugLineNum = 59;BA.debugLine="loadDBlogo";
Debug.ShouldStop(67108864);
_loaddblogo();
 BA.debugLineNum = 60;BA.debugLine="loadDBname";
Debug.ShouldStop(134217728);
_loaddbname();
 BA.debugLineNum = 61;BA.debugLine="loadStamp";
Debug.ShouldStop(268435456);
_loadstamp();
 BA.debugLineNum = 62;BA.debugLine="loadDBbuttonColours";
Debug.ShouldStop(536870912);
_loaddbbuttoncolours();
 BA.debugLineNum = 64;BA.debugLine="CoffeeCount=5";
...
try {
		Debug.PushSubsStack("btnno_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,210);
if (RapidSub.canDelegate("btnno_click")) return main.remoteMe.runUserSub(false, "main","btnno_click");
 BA.debugLineNum = 210;BA.debugLine="Sub btnno_Click ' you can also save and redeem lat";
Debug.ShouldStop(131072);
 BA.debugLineNum = 211;BA.debugLine="Activity.LoadLayout(\"main\") 'will return to main";
...
if (RapidSub.canDelegate("btnscan_click")) return main.remoteMe.runUserSub(false, "main","btnscan_click");
 BA.debugLineNum = 201;BA.debugLine="Sub btnScan_Click 'in order to bring information a";
Debug.ShouldStop(256);
 BA.debugLineNum = 202;BA.debugLine="updateStamps";
...
main.mostCurrent._qrscanner.setField ("theBottomPromptTextSize",main.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),main.mostCurrent.activityBA));
 BA.debugLineNum = 234;BA.debugLine="qrscanner.bottomPromptColor = Colors.Yellow";
Debug.ShouldStop(512);
main.mostCurrent._qrscanner.setField ("bottomPromptColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Yellow"));
 BA.debugLineNum = 235;BA.debugLine="qrscanner.bottomPromptDistanceFromBottom = 5%y";
Debug.ShouldStop(1024);
main.mostCurrent._qrscanner.setField ("bottomPromptDistanceFromBottom",main.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 5)),main.mostCurrent.activityBA));
 BA.debugLineNum = 237;BA.debugLine="scanSuccess = False";
Debug.ShouldStop(4096);
main._scansuccess = main.mostCurrent.__c.getField(true,"False");
 BA.debugLineNum = 238;BA.debugLine="qrscanner.BeginScan(\"scanner\")	'This is the funct";
...
try {
		Debug.PushSubsStack("btnyes_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,204);
if (RapidSub.canDelegate("btnyes_click")) return main.remoteMe.runUserSub(false, "main","btnyes_click");
 BA.debugLineNum = 204;BA.debugLine="Sub btnyes_Click 'to redeem your free coffee press";
Debug.ShouldStop(2048);
 BA.debugLineNum = 205;BA.debugLine="CoffeeCount = 0";
Debug.ShouldStop(4096);
main._coffeecount = BA.numberCast(int.class, 0);
 BA.debugLineNum = 206;BA.debugLine="updateStamps";
Debug.ShouldStop(8192);
_updatestamps();
 BA.debugLineNum = 207;BA.debugLine="Activity.LoadLayout(\"main\")";
...
public static RemoteObject  _globals() throws Exception{
 ...
 //BA.debugLineNum = 37;BA.debugLine="Dim Card As Card";
...
main._scansuccess = RemoteObject.createImmutable(false);
 //BA.debugLineNum = 48;BA.debugLine="Dim qrscanner As JhsIceZxing1";
main.mostCurrent._qrscanner = RemoteObject.createNew ("ice.zxing.b4aZXingLib");
 //BA.debugLineNum = 50;BA.debugLine="Private No As Button";
main.mostCurrent._no = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
 //BA.debugLineNum = 51;BA.debugLine="Private Yes As Button";
...
main._myconame.runMethod(true,"setPosition",BA.numberCast(int.class, _i));
 BA.debugLineNum = 97;BA.debugLine="lblCompanyName.Text  =myCoName.GetString(\"Name\")";
Debug.ShouldStop(1);
main.mostCurrent._lblcompanyname.runMethod(true,"setText",(main._myconame.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("Name")))));
 }
}Debug.locals.put("i", _i);
;
...
storepurchase_subs_0._process_globals();
...
storepurchase.myClass = BA.getDeviceClass ("b4a.example.storepurchase");
...
try {
		Debug.PushSubsStack("scanner_noscan (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,252);
...
Debug.locals.put("Values", _values);
 BA.debugLineNum = 252;BA.debugLine="Sub scanner_noscan(atype As String,Values As Strin";
Debug.ShouldStop(134217728);
...
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("type:"),_atype,RemoteObject.createImmutable("Values:"),_values)));
 BA.debugLineNum = 254;BA.debugLine="Msgbox(Values,\"Scan Failed\")";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("scanner_result (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,243);
if (RapidSub.canDelegate("scanner_result")) return main.remoteMe.runUserSub(false, "main","scanner_result", _atype, _values);
Debug.locals.put("atype", _atype);
Debug.locals.put("Values", _values);
 BA.debugLineNum = 243;BA.debugLine="Sub scanner_result(atype As String,Values As Strin";
Debug.ShouldStop(262144);
 BA.debugLineNum = 244;BA.debugLine="If Values <> \"Null\" Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("!",_values,BA.ObjectToString("Null"))) { 
 BA.debugLineNum = 245;BA.debugLine="scanSuccess = True";
Debug.ShouldStop(1048576);
main._scansuccess = main.mostCurrent.__c.getField(true,"True");
 BA.debugLineNum = 246;BA.debugLine="CoffeeCount = CoffeeCount + 1";
Debug.ShouldStop(2097152);
main._coffeecount = RemoteObject.solve(new RemoteObject[] {main._coffeecount,RemoteObject.createImmutable(1)}, "+",1, 1);
 BA.debugLineNum = 247;BA.debugLine="Log(\"type:\" & atype &  \"Values:\" & Values)";
Debug.ShouldStop(4194304);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("type:"),_atype,RemoteObject.createImmutable("Values:"),_values)));
 };
 BA.debugLineNum = 249;BA.debugLine="updateStamps";
Debug.ShouldStop(16777216);
_updatestamps();
