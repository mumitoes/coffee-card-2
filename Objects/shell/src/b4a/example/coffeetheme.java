...
public class coffeetheme implements IRemote{
	public static coffeetheme mostCurrent;
...
public boolean isSingleton() {
    ...
    public static PCBA staticBA = new PCBA(null, coffeetheme.class);
    private PCBA pcBA;
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(null, coffeetheme.class);
		return pcBA;
	}
