...
public class databasemanager implements IRemote{
	public static databasemanager mostCurrent;
...
public boolean isSingleton() {
    ...
    public static PCBA staticBA = new PCBA(null, databasemanager.class);
    private PCBA pcBA;
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(null, databasemanager.class);
		return pcBA;
	}
