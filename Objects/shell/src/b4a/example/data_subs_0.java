...
try {
		Debug.PushSubsStack("CreateCard (data) ","data",3,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("Initialize (data) ","data",3,__ref.getField(false, "ba"),__ref,8);
...
try {
		Debug.PushSubsStack("LoadCard (data) ","data",3,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("SaveCard (data) ","data",3,__ref.getField(false, "ba"),__ref,13);
