...
innerInitialize(_ba);
try {
		Debug.PushSubsStack("Initialize (thememanager) ","thememanager",9,ba,this,9);
...
try {
		Debug.PushSubsStack("loadAddress (thememanager) ","thememanager",9,ba,this,48);
String _address = "";
int _i = 0;
String _address2 = "";
...
try {
		Debug.PushSubsStack("LoadBGColours (thememanager) ","thememanager",9,ba,this,14);
...
try {
		Debug.PushSubsStack("loadDBbuttonColours (thememanager) ","thememanager",9,ba,this,74);
...
try {
		Debug.PushSubsStack("loadDBlogo (thememanager) ","thememanager",9,ba,this,64);
...
try {
		Debug.PushSubsStack("loadName (thememanager) ","thememanager",9,ba,this,37);
String _name = "";
int _i = 0;
...
try {
		Debug.PushSubsStack("loadPhone (thememanager) ","thememanager",9,ba,this,27);
String _phone = "";
int _i = 0;
...
try {
		Debug.PushSubsStack("loadStamp (thememanager) ","thememanager",9,ba,this,86);
int _i = 0;
