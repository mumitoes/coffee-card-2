...
try {
		Debug.PushSubsStack("loadBtnColours (coffeetheme) ","coffeetheme",1,ba,this,44);
 BA.debugLineNum = 44;BA.debugLine="Sub loadBtnColours As Cursor";
Debug.ShouldStop(2048);
 BA.debugLineNum = 45;BA.debugLine="cursor1=SQL1.ExecQuery(\"SELECT BtnRed, BtnBlue, Bt";
Debug.ShouldStop(4096);
_cursor1.setObject((android.database.Cursor)(_sql1.ExecQuery("SELECT BtnRed, BtnBlue, BtnGreen FROM themes")));
 BA.debugLineNum = 46;BA.debugLine="Return cursor1";
Debug.ShouldStop(8192);
