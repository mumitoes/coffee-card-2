...
RDebugUtils.currentLine=2162688;
 //BA.debugLineNum = 2162688;BA.debugLine="Public Sub CreateCard(CardName As String, StampCou";
RDebugUtils.currentLine=2162689;
 //BA.debugLineNum = 2162689;BA.debugLine="If(File.Exists(File.DirInternal, CardName) = F";
if ((__c.File.Exists(__c.File.getDirInternal(),_cardname)==__c.False)) { 
RDebugUtils.currentLine=2162690;
 //BA.debugLineNum = 2162690;BA.debugLine="File.WriteString(File.DirInternal, CardName, Stam";
...
RDebugUtils.currentLine=2228224;
 //BA.debugLineNum = 2228224;BA.debugLine="Public Sub LoadCard(CardName As String) As Int()";
RDebugUtils.currentLine=2228225;
 //BA.debugLineNum = 2228225;BA.debugLine="Dim BonusNumber As Int = 7 'defaults";
_bonusnumber = (int) (7);
RDebugUtils.currentLine=2228226;
 //BA.debugLineNum = 2228226;BA.debugLine="Dim StampCount As Int = 0";
_stampcount = (int) (0);
RDebugUtils.currentLine=2228227;
 //BA.debugLineNum = 2228227;BA.debugLine="Dim cardData As String";
_carddata = "";
RDebugUtils.currentLine=2228229;
 //BA.debugLineNum = 2228229;BA.debugLine="If File.Exists(File.DirInternal, CardName) = Fals";
if (__c.File.Exists(__c.File.getDirInternal(),_cardname)==__c.False) { 
RDebugUtils.currentLine=2228230;
 //BA.debugLineNum = 2228230;BA.debugLine="File.WriteString(File.DirInternal, CardName, \"0,7";
__c.File.WriteString(__c.File.getDirInternal(),_cardname,"0,7");
 };
RDebugUtils.currentLine=2228233;
 //BA.debugLineNum = 2228233;BA.debugLine="If(File.Exists(File.DirInternal, CardName)) Then";
if ((__c.File.Exists(__c.File.getDirInternal(),_cardname))) { 
RDebugUtils.currentLine=2228234;
 //BA.debugLineNum = 2228234;BA.debugLine="cardData = File.ReadString(File.DirInternal, Card";
_carddata = __c.File.ReadString(__c.File.getDirInternal(),_cardname);
RDebugUtils.currentLine=2228235;
 //BA.debugLineNum = 2228235;BA.debugLine="Dim SplitIndex As Int = cardData.IndexOf(\",\")";
_splitindex = _carddata.indexOf(",");
RDebugUtils.currentLine=2228237;
 //BA.debugLineNum = 2228237;BA.debugLine="ToastMessageShow(cardData, True)";
__c.ToastMessageShow(_carddata,__c.True);
RDebugUtils.currentLine=2228238;
 //BA.debugLineNum = 2228238;BA.debugLine="StampCount = cardData.SubString2(0,SplitIndex)";
_stampcount = (int)(Double.parseDouble(_carddata.substring((int) (0),_splitindex)));
RDebugUtils.currentLine=2228239;
 //BA.debugLineNum = 2228239;BA.debugLine="BonusNumber = cardData.SubString(SplitIndex+1)";
_bonusnumber = (int)(Double.parseDouble(_carddata.substring((int) (_splitindex+1))));
 };
RDebugUtils.currentLine=2228242;
 //BA.debugLineNum = 2228242;BA.debugLine="Dim IntData(2) As Int";
_intdata = new int[(int) (2)];
;
RDebugUtils.currentLine=2228243;
 //BA.debugLineNum = 2228243;BA.debugLine="IntData(0) = StampCount";
_intdata[(int) (0)] = _stampcount;
RDebugUtils.currentLine=2228244;
 //BA.debugLineNum = 2228244;BA.debugLine="IntData(1) = BonusNumber";
_intdata[(int) (1)] = _bonusnumber;
RDebugUtils.currentLine=2228245;
 //BA.debugLineNum = 2228245;BA.debugLine="Return IntData";
...
RDebugUtils.currentLine=2097152;
 //BA.debugLineNum = 2097152;BA.debugLine="Sub SaveCard(CoffeeCount As Int, BonusNumber As In";
RDebugUtils.currentLine=2097153;
 //BA.debugLineNum = 2097153;BA.debugLine="CoffeeCount = 1";
_coffeecount = (int) (1);
RDebugUtils.currentLine=2097154;
 //BA.debugLineNum = 2097154;BA.debugLine="BonusNumber = 7";
_bonusnumber = (int) (7);
RDebugUtils.currentLine=2097155;
 //BA.debugLineNum = 2097155;BA.debugLine="Dim CountFromCard As Int";
_countfromcard = 0;
RDebugUtils.currentLine=2097158;
 //BA.debugLineNum = 2097158;BA.debugLine="If File.Exists(File.DirInternal, \"CoffeeCount.txt\"";
if (__c.File.Exists(__c.File.getDirInternal(),"CoffeeCount.txt")==__c.False) { 
RDebugUtils.currentLine=2097159;
 //BA.debugLineNum = 2097159;BA.debugLine="File.WriteString(File.DirInternal, \"CoffeeCount.tx";
__c.File.WriteString(__c.File.getDirInternal(),"CoffeeCount.txt",BA.NumberToString(_coffeecount));
 }else {
RDebugUtils.currentLine=2097163;
 //BA.debugLineNum = 2097163;BA.debugLine="CountFromCard =    File.ReadString(File.DirInterna";
...
RDebugUtils.currentLine=2097166;
 //BA.debugLineNum = 2097166;BA.debugLine="CountFromCard = CountFromCard + CoffeeCount";
_countfromcard = (int) (_countfromcard+_coffeecount);
RDebugUtils.currentLine=2097169;
 //BA.debugLineNum = 2097169;BA.debugLine="File.WriteString(File.DirInternal, \"CoffeeCount.tx";
