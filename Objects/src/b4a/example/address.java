...
RDebugUtils.currentLine=2818052;
 //BA.debugLineNum = 2818052;BA.debugLine="File.Copy(File.DirAssets, \"customerthemes.sqlite\"";
__c.File.Copy(__c.File.getDirAssets(),"customerthemes.sqlite",__c.File.getDirInternal(),"customerthemes.sqlite");
RDebugUtils.currentLine=2818056;
 //BA.debugLineNum = 2818056;BA.debugLine="If SQL1.IsInitialized=False Then";
if (__ref._sql1.IsInitialized()==__c.False) { 
RDebugUtils.currentLine=2818057;
 //BA.debugLineNum = 2818057;BA.debugLine="SQL1.Initialize(File.DirInternal, \"customerthemes";
