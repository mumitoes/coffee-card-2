...
innerInitialize(_ba);
try {
		Debug.PushSubsStack("Initialize (databasemanager) ","databasemanager",8,ba,this,12);
...
try {
		Debug.PushSubsStack("loadBtnColours (databasemanager) ","databasemanager",8,ba,this,42);
...
try {
		Debug.PushSubsStack("loadColours (databasemanager) ","databasemanager",8,ba,this,26);
...
try {
		Debug.PushSubsStack("loadCompanyDetails (databasemanager) ","databasemanager",8,ba,this,47);
...
try {
		Debug.PushSubsStack("loadLogo (databasemanager) ","databasemanager",8,ba,this,31);
...
try {
		Debug.PushSubsStack("loadStampIcon (databasemanager) ","databasemanager",8,ba,this,36);
