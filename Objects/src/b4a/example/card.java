...
public b4a.example.themecalc _themecalc = null;
  public Object[] GetGlobals() {
		return new Object[] {"Card",Debug.moduleToString(b4a.example.card.class),"CoffeeCount",_coffeecount,"img7",_img7,"Main",Debug.moduleToString(b4a.example.main.class),"ThemeCalc",Debug.moduleToString(b4a.example.themecalc.class)};
}
...
Debug.ShouldStop(2048);
 BA.debugLineNum = 13;BA.debugLine="CoffeeCount = CoffeeCount + 1 'Adds 1 stamp to co";
Debug.ShouldStop(4096);
_coffeecount = (int) (_coffeecount+1);
 BA.debugLineNum = 14;BA.debugLine="Return CoffeeCount ' and returns the new number o";
...
try {
		Debug.PushSubsStack("Redeem (card) ","card",2,ba,this,17);
 BA.debugLineNum = 17;BA.debugLine="Sub Redeem As Boolean  'this part of code will hol";
Debug.ShouldStop(65536);
 BA.debugLineNum = 18;BA.debugLine="If CoffeeCount = 6 Then ' if the person got 6 sta";
Debug.ShouldStop(131072);
if (_coffeecount==6) { 
 BA.debugLineNum = 19;BA.debugLine="img7.Initialize(File.DirAssets,\"free-coffee-1-2.";
