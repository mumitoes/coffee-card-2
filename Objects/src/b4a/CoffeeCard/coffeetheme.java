...
public class coffeetheme extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.CoffeeCard.coffeetheme");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "b4a.CoffeeCard.coffeetheme",
                    ba);
                return;
		    }
        }
...
try {
		Debug.PushSubsStack("DrinkExtras (coffeetheme) ","coffeetheme",9,ba,this,67);
...
try {
		Debug.PushSubsStack("ExtraSelect (coffeetheme) ","coffeetheme",9,ba,this,72);
...
innerInitialize(_ba);
try {
		Debug.PushSubsStack("Initialize (coffeetheme) ","coffeetheme",9,ba,this,12);
...
try {
		Debug.PushSubsStack("loadBtnColours (coffeetheme) ","coffeetheme",9,ba,this,47);
...
try {
		Debug.PushSubsStack("loadCoffeeMenu (coffeetheme) ","coffeetheme",9,ba,this,57);
 BA.debugLineNum = 57;BA.debugLine="Sub loadCoffeeMenu As Cursor";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 58;BA.debugLine="cursor1=SQL1.ExecQuery(\"SELECT ID, CoffeeName, Des";
...
try {
		Debug.PushSubsStack("loadColours (coffeetheme) ","coffeetheme",9,ba,this,26);
...
try {
		Debug.PushSubsStack("loadCompanyDetails (coffeetheme) ","coffeetheme",9,ba,this,52);
 BA.debugLineNum = 52;BA.debugLine="Sub loadCompanyDetails As Cursor 'load company inf";
Debug.ShouldStop(524288);
 BA.debugLineNum = 53;BA.debugLine="cursor1=SQL1.ExecQuery(\"SELECT CompanyName, Addre";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("loadCompanyName (coffeetheme) ","coffeetheme",9,ba,this,36);
 BA.debugLineNum = 36;BA.debugLine="Sub loadCompanyName As Cursor";
Debug.ShouldStop(8);
 BA.debugLineNum = 37;BA.debugLine="cursor1=SQL1.ExecQuery(\"SELECT CompanyName FROM Co";
Debug.ShouldStop(16);
_cursor1.setObject((android.database.Cursor)(_sql1.ExecQuery("SELECT CompanyName FROM CompanyDetails")));
...
try {
		Debug.PushSubsStack("loadLogo (coffeetheme) ","coffeetheme",9,ba,this,31);
...
try {
		Debug.PushSubsStack("loadStampIcon (coffeetheme) ","coffeetheme",9,ba,this,41);
...
try {
		Debug.PushSubsStack("SelectDrink (coffeetheme) ","coffeetheme",9,ba,this,62);
 BA.debugLineNum = 62;BA.debugLine="Sub SelectDrink As Cursor";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 63;BA.debugLine="cursor1=SQL1.ExecQuery(\"SELECT CoffeeName FROM Cof";
Debug.ShouldStop(1073741824);
