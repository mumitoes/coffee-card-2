...
public class thememanager extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.CoffeeCard.thememanager");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "b4a.CoffeeCard.thememanager",
                    ba);
                return;
		    }
        }
...
public b4a.CoffeeCard.databasemanager _mydata = null;
...
_mydata = new b4a.CoffeeCard.databasemanager();
...
innerInitialize(_ba);
try {
		Debug.PushSubsStack("Initialize (thememanager) ","thememanager",1,ba,this,9);
...
try {
		Debug.PushSubsStack("LoadBGColours (thememanager) ","thememanager",1,ba,this,14);
...
try {
		Debug.PushSubsStack("loadDBbuttonColours (thememanager) ","thememanager",1,ba,this,58);
...
try {
		Debug.PushSubsStack("loadDBlogo (thememanager) ","thememanager",1,ba,this,48);
...
try {
		Debug.PushSubsStack("loadMap (thememanager) ","thememanager",1,ba,this,80);
String _address = "";
String _url = "";
int _i = 0;
String _address2 = "";
...
try {
		Debug.PushSubsStack("loadName (thememanager) ","thememanager",1,ba,this,37);
String _name = "";
int _i = 0;
...
try {
		Debug.PushSubsStack("loadPhone (thememanager) ","thememanager",1,ba,this,27);
String _phone = "";
int _i = 0;
...
try {
		Debug.PushSubsStack("loadStamp (thememanager) ","thememanager",1,ba,this,70);
int _i = 0;
