...
public class address extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.CoffeeCard.address");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "b4a.CoffeeCard.address",
                    ba);
                return;
		    }
        }
...
public b4a.CoffeeCard.coffeetheme _mydata = null;
...
public b4a.CoffeeCard.themecalc _themecalc = null;
  public Object[] GetGlobals() {
		return new Object[] {"DrinkExtras",Debug.moduleToString(b4a.CoffeeCard.drinkextras.class),"DrinkMenu",Debug.moduleToString(b4a.CoffeeCard.drinkmenu.class),"Main",Debug.moduleToString(b4a.CoffeeCard.main.class),"MapLocator",Debug.moduleToString(b4a.CoffeeCard.maplocator.class),"myAddress",_myaddress,"myButtonColours",_mybuttoncolours,"myColors",_mycolors,"myContactDeets",_mycontactdeets,"myData",_mydata,"myLogo",_mylogo,"myStamp",_mystamp,"StorePurchase",Debug.moduleToString(b4a.CoffeeCard.storepurchase.class),"ThemeCalc",Debug.moduleToString(b4a.CoffeeCard.themecalc.class)};
}
...
_mydata = new b4a.CoffeeCard.coffeetheme();
...
innerInitialize(_ba);
try {
		Debug.PushSubsStack("Initialize (address) ","address",11,ba,this,9);
...
try {
		Debug.PushSubsStack("loadAddress (address) ","address",11,ba,this,48);
String _address = "";
int _i = 0;
String _address2 = "";
...
try {
		Debug.PushSubsStack("LoadBGColours (address) ","address",11,ba,this,14);
...
try {
		Debug.PushSubsStack("loadDBbuttonColours (address) ","address",11,ba,this,74);
...
try {
		Debug.PushSubsStack("loadDBlogo (address) ","address",11,ba,this,64);
...
try {
		Debug.PushSubsStack("loadName (address) ","address",11,ba,this,37);
String _name = "";
int _i = 0;
...
_mycontactdeets.setPosition(_i);
 BA.debugLineNum = 42;BA.debugLine="name  = myContactDeets.GetString(\"CompanyName\")";
Debug.ShouldStop(512);
_name = _mycontactdeets.GetString("CompanyName");Debug.locals.put("name", _name);
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("loadPhone (address) ","address",11,ba,this,27);
String _phone = "";
int _i = 0;
...
try {
		Debug.PushSubsStack("loadStamp (address) ","address",11,ba,this,86);
int _i = 0;
