...
public class maplocator extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.CoffeeCard", "b4a.CoffeeCard.maplocator");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.CoffeeCard", "b4a.CoffeeCard.maplocator");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.CoffeeCard.maplocator", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public b4a.CoffeeCard.themecalc _themecalc = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"companyDetails",mostCurrent._companydetails,"DrinkExtras",Debug.moduleToString(b4a.CoffeeCard.drinkextras.class),"DrinkMenu",Debug.moduleToString(b4a.CoffeeCard.drinkmenu.class),"imgLogo",mostCurrent._imglogo,"lblCompanyName",mostCurrent._lblcompanyname,"lblPhone",mostCurrent._lblphone,"Main",Debug.moduleToString(b4a.CoffeeCard.main.class),"PnlBg",mostCurrent._pnlbg,"StorePurchase",Debug.moduleToString(b4a.CoffeeCard.storepurchase.class),"ThemeCalc",Debug.moduleToString(b4a.CoffeeCard.themecalc.class),"WebView1",mostCurrent._webview1};
}
...
try {
		Debug.PushSubsStack("Activity_Create (maplocator) ","maplocator",8,mostCurrent.activityBA,mostCurrent,22);
...
try {
		Debug.PushSubsStack("Activity_Pause (maplocator) ","maplocator",8,mostCurrent.activityBA,mostCurrent,36);
...
try {
		Debug.PushSubsStack("Activity_Resume (maplocator) ","maplocator",8,mostCurrent.activityBA,mostCurrent,32);
...
try {
		Debug.PushSubsStack("loadLayout (maplocator) ","maplocator",8,mostCurrent.activityBA,mostCurrent,40);
