...
public class card extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.CoffeeCard.card");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "b4a.CoffeeCard.card",
                    ba);
                return;
		    }
        }
...
public b4a.CoffeeCard.themecalc _themecalc = null;
  public Object[] GetGlobals() {
		return new Object[] {"Card",Debug.moduleToString(b4a.CoffeeCard.card.class),"CoffeeCount",_coffeecount,"DrinkExtras",Debug.moduleToString(b4a.CoffeeCard.drinkextras.class),"DrinkMenu",Debug.moduleToString(b4a.CoffeeCard.drinkmenu.class),"img7",_img7,"Main",Debug.moduleToString(b4a.CoffeeCard.main.class),"MapLocator",Debug.moduleToString(b4a.CoffeeCard.maplocator.class),"StorePurchase",Debug.moduleToString(b4a.CoffeeCard.storepurchase.class),"ThemeCalc",Debug.moduleToString(b4a.CoffeeCard.themecalc.class)};
}
public String  _class_globals() throws Exception{
 //BA.debugLineNum = 2;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 3;BA.debugLine="Dim Card As Card";
_card = new b4a.CoffeeCard.card();
...
public int  _coffee_stamp() throws Exception{
try {
		Debug.PushSubsStack("Coffee_Stamp (card) ","card",6,ba,this,12);
 BA.debugLineNum = 12;BA.debugLine="Sub Coffee_Stamp As Int";
...
innerInitialize(_ba);
try {
		Debug.PushSubsStack("Initialize (card) ","card",6,ba,this,8);
...
try {
		Debug.PushSubsStack("Redeem (card) ","card",6,ba,this,16);
